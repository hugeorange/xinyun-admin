<template>
  <div class="bg-white">
    <div class="page-title p-4">用户信息</div>
    <div class="p-4">
      <TableForm
        :fields="[
          { name: '用户名称:', propName: 'name', type: 'text', value: '' },
  ...
  <div class="mt-4 p-4 bg-white">
    ...
    <el-table
      ...
      <el-table-column property="name" label="客户全名" width="120" />
      <el-table-column property="name" label="联系人" width="120" />
      <el-table-column property="name" label="联系电话" width="120" />
